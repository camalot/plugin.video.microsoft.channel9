...
class Main:
    ...
    def get_videos(self):
        ...
        url = "http://channel9.msdn.com/%s/posts?page=%u&lang=en" % (self.author_url, self.current_page)
        ...
        for li_entry in li_entries:
            ...
            # check if the entry is a video
            if div_entry_image.find("div", {"class": "entry-caption"}) is None:
                continue
