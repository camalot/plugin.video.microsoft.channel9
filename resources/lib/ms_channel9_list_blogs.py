...
class Main:
    ...
    def __init__(self):
        ...
        self.show_url = urllib.unquote_plus(params.get("blog-url"))
        self.current_page = int(params.get("page", "1"))

        print "blog-url: %s" % self.show_url
    ...
    def get_videos(self):
        ...
        if ul_paging:
            ...
            xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]), url="%s?action=list-blog&event-url=%s&page=%i" % (
